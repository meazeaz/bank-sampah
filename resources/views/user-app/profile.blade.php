    ...
    <div class="container d-flex justify-content-evenly">
        ...
        <div>
            <a class="btn btn-lg border-0 px-1 py-auto" href="/profile">
                <i class="bi bi-person-fill" style="font-size: 1.4rem; color: var(--primary-color);"></i>
                <p class="fw-bold font-sm p-0 m-0" style="color: var(--primary-color); font-size: 11px !important;">Profil</p>
            </a>
        </div>
        <div>
