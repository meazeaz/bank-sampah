<?php namespace App\Http\Controllers;
	...
	class AdminSampahController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Poin per Kg","name"=>"point_per_kg"];
			...
			$this->form[] = ['label'=>'Price Per Kg (Rp)','name'=>'price_per_kg','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Point Per Kg','name'=>'point_per_kg','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10','help'=>'Jumlah poin yang didapat nasabah per kilogram sampah ini. Contoh: 5 = 5 poin per kg'];
